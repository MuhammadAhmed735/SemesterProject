...
import com.example.myapplication.adapters.StudentTaskPagerAdapter;
 ...
 */
public class StudentTaskList extends Fragment {

    private TabLayout tabLayout;
    private ViewPager2 viewPager;
    private StudentTaskPagerAdapter adapter;
    ...
    public static StudentTaskList newInstance(String param1, String param2) {
        StudentTaskList fragment = new StudentTaskList();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new StudentTaskPagerAdapter(getChildFragmentManager(), getLifecycle());
