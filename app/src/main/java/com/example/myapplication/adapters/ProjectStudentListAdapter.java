...
public class ProjectStudentListAdapter extends RecyclerView.Adapter<ProjectStudentListAdapter.StudentViewHolder> {

    private List<ProjectSubmission> projectSubmissions; // List to hold task submissions
    private FirebaseFirestore db;
    private OnItemClickListener listener;
    private OnMarkButtonClickListener buttonClickListener;

    public ProjectStudentListAdapter(List<ProjectSubmission> projectSubmissions) {
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ProjectSubmission submission = projectSubmissions.get(position);
        ...
        holder.projectStatus.setText(submission.getStatus());
    ...
    public int getItemCount() {
        return projectSubmissions.size();
    }

    public static class StudentViewHolder extends RecyclerView.ViewHolder {
        TextView studentName, projectStatus, completionTime;
        Button markButton;
    ...
    public interface OnItemClickListener {
        void onItemClick(ProjectSubmission submission);
    }
